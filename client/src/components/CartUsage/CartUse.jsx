              ...
              <Col>
                <Row>
                  ...
                  <Col
                    xs={6}
                    md={3}
                    className="text-left ml-2 number"
                    style={{ color: "white" }}
                  >
                  ...
                  <Col
                    className="text-left ml-4 number"
                    style={{ color: "white" }}
                  >
                    <span className="h3">
                      <IoMdTrash />
                      ...
                      <div>
                        <p>
                          <img
                            ...
                            alt="sad cart"
                          ></img>
                          <h3> Your cart is empty!</h3> <br></br> Add something
                          to make me happy :)
                        </p>
                      </div>
                    )
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    updateProductToCart: (idUser, body) =>
      dispatch(updateProductToCart(idUser, body)),
